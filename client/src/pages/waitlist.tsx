...
const locations = [
  ...
  "Casablanca, Morocco", "Rabat, Morocco", "Fès, Morocco", "Marrakech, Morocco",
  ...
  "Khartoum, Sudan", "Omdurman, Sudan", "Kassala, Sudan", "Port Sudan, Sudan",
  ...
  "Mbabane, Eswatini", "Manzini, Eswatini", "Lobamba, Eswatini", "Siteki, Eswatini",
  ...
  "Victoria, Seychelles", "Anse Boileau, Seychelles", "Beau Vallon, Seychelles", "Takamaka, Seychelles",
  "Moroni, Comoros", "Mutsamudu, Comoros", "Domoni, Comoros", "Fomboni, Comoros",
  "Praia, Cape Verde", "Mindelo, Cape Verde", "Santa Maria, Cape Verde", "Assomada, Cape Verde",
  ...
  "Brazzaville, Republic of Congo", "Pointe-Noire, Republic of Congo", "Dolisie, Republic of Congo",
  "Kinshasa, Democratic Republic of Congo", "Lubumbashi, Democratic Republic of Congo", "Mbuji-Mayi, Democratic Republic of Congo",
  ...
  "Monrovia, Liberia", "Gbarnga, Liberia", "Buchanan, Liberia", "Kakata, Liberia",
  "Yamoussoukro, Ivory Coast", "Abidjan, Ivory Coast", "Bouaké, Ivory Coast", "Daloa, Ivory Coast",
  "Accra, Ghana", "Kumasi, Ghana", "Tamale, Ghana", "Takoradi, Ghana",
  "Lomé, Togo", "Sokodé, Togo", "Kara, Togo", "Palimé, Togo",
  "Porto-Novo, Benin", "Cotonou, Benin", "Parakou, Benin", "Djougou, Benin",
  ...
  "Oklahoma City, USA", "Las Vegas, USA", "Louisville, USA", "Baltimore, USA", "Milwaukee, USA",
  "Albuquerque, USA", "Tucson, USA", "Fresno, USA", "Sacramento, USA", "Kansas City, USA",
  "Mesa, USA", "Atlanta, USA", "Omaha, USA", "Colorado Springs, USA", "Raleigh, USA",
  "Miami, USA", "Cleveland, USA", "Tulsa, USA", "Oakland, USA", "Minneapolis, USA",
  "Wichita, USA", "Arlington, USA", "Bakersfield, USA", "New Orleans, USA", "Honolulu, USA",
  "Anchorage, USA", "Anaheim, USA", "Tampa, USA", "Aurora, USA", "Santa Ana, USA",
  "St. Louis, USA", "Riverside, USA", "Corpus Christi, USA", "Lexington, USA", "Pittsburgh, USA",
  "Stockton, USA", "Cincinnati, USA", "St. Paul, USA", "Toledo, USA", "Greensboro, USA",
  "Newark, USA", "Plano, USA", "Henderson, USA", "Lincoln, USA", "Buffalo, USA",
  "Jersey City, USA", "Chula Vista, USA", "Fort Wayne, USA", "Orlando, USA", "St. Petersburg, USA",
  "Chandler, USA", "Laredo, USA", "Norfolk, USA", "Durham, USA", "Madison, USA",
  // Central America and Caribbean
  "Guatemala City, Guatemala", "Quetzaltenango, Guatemala", "Escuintla, Guatemala", "Mazatenango, Guatemala",
  "Belize City, Belize", "San Ignacio, Belize", "Orange Walk, Belize", "Dangriga, Belize",
  "Tegucigalpa, Honduras", "San Pedro Sula, Honduras", "Choloma, Honduras", "La Ceiba, Honduras",
  ...
  "Panama City, Panama", "San Miguelito, Panama", "Tocumen, Panama", "David, Panama",
  ...
  "Port-au-Prince, Haiti", "Cap-Haïtien, Haiti", "Gonaïves, Haiti", "Les Cayes, Haiti",
  "Santo Domingo, Dominican Republic", "Santiago, Dominican Republic", "San Pedro de Macorís, Dominican Republic",
  "San Juan, Puerto Rico", "Bayamón, Puerto Rico", "Carolina, Puerto Rico", "Ponce, Puerto Rico",
  "Bridgetown, Barbados", "Speightstown, Barbados", "Oistins, Barbados", "Holetown, Barbados",
  "Port of Spain, Trinidad and Tobago", "San Fernando, Trinidad and Tobago", "Chaguanas, Trinidad and Tobago",
  "St. George's, Grenada", "Gouyave, Grenada", "Grenville, Grenada", "Hillsborough, Grenada",
  "Castries, Saint Lucia", "Gros Islet, Saint Lucia", "Soufrière, Saint Lucia", "Vieux Fort, Saint Lucia",
  ...
  "Basseterre, Saint Kitts and Nevis", "Charlestown, Saint Kitts and Nevis", "Newcastle, Saint Kitts and Nevis",
  // Oceania (additional cities)
  "Auckland, New Zealand", "Wellington, New Zealand", "Christchurch, New Zealand", "Hamilton, New Zealand",
  "Tauranga, New Zealand", "Dunedin, New Zealand", "Palmerston North, New Zealand", "Napier, New Zealand",
  "Port Moresby, Papua New Guinea", "Lae, Papua New Guinea", "Mount Hagen, Papua New Guinea", "Madang, Papua New Guinea",
  "Suva, Fiji", "Nasinu, Fiji", "Lautoka, Fiji", "Nadi, Fiji",
  "Port Vila, Vanuatu", "Luganville, Vanuatu", "Isangel, Vanuatu", "Sola, Vanuatu",
  "Honiara, Solomon Islands", "Auki, Solomon Islands", "Gizo, Solomon Islands", "Munda, Solomon Islands",
  "Apia, Samoa", "Asau, Samoa", "Mulifanua, Samoa", "Leulumoega, Samoa",
  "Nuku'alofa, Tonga", "Neiafu, Tonga", "Haveluloto, Tonga", "Vaini, Tonga",
  "Avarua, Cook Islands", "Arorangi, Cook Islands", "Titikaveka, Cook Islands", "Matavera, Cook Islands",
  "Funafuti, Tuvalu", "Asau, Tuvalu", "Lolua, Tuvalu", "Kulia, Tuvalu",
  "Yaren, Nauru", "Aiwo, Nauru", "Anabar, Nauru", "Anetan, Nauru",
  "Ngerulmud, Palau", "Koror, Palau", "Airai, Palau", "Melekeok, Palau",
  "Majuro, Marshall Islands", "Ebeye, Marshall Islands", "Arno, Marshall Islands", "Mili, Marshall Islands",
  "Palikir, Federated States of Micronesia", "Weno, Federated States of Micronesia", "Tofol, Federated States of Micronesia",
  "Tarawa, Kiribati", "Betio, Kiribati", "Bikenibeu, Kiribati", "Teaoraereke, Kiribati",
  "Papeete, French Polynesia", "Faaa, French Polynesia", "Punaauia, French Polynesia", "Pirae, French Polynesia",
  "Nouméa, New Caledonia", "Mont-Dore, New Caledonia", "Dumbéa, New Caledonia", "Païta, New Caledonia",
  "Other"
];
