...
import { Trophy, Crown, Medal, Award, Plus, TrendingUp, Users, Target } from "lucide-react";
...
export default function BrandChallenges() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-64">
        <BrandHeader title="Challenges" breadcrumb={["Challenges"]} />
        
        <main className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Challenges</h1>
              <p className="text-gray-500 mt-1">Create viral challenges and discover top-performing creators</p>
            </div>
            <Button className="bg-[#8B5CF6] hover:bg-[#7C3AED]" data-testid="button-create-challenge">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
                ...
                <div className="lg:col-span-3 space-y-3">
                  <div className="flex items-center justify-between mb-4">
                    <h2 className="text-xl font-semibold text-gray-900 flex items-center gap-2">
                      <span>🐝</span> Top Creators by Hive Score
                    </h2>
            ...
            <TabsContent value="active" className="mt-6">
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 mb-4">Create your first challenge to engage with top creators</p>
            ...
            <TabsContent value="past" className="mt-6">
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">No past challenges</h3>
